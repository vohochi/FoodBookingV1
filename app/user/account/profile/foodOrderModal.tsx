...
import { Dialog, DialogContent, DialogTitle, Typography, Grid, Button, Divider, TextField, Rating, List, ListItem, ListItemText, IconButton, InputAdornment } from '@mui/material';
...
const ProductDetailModal: React.FC<ProductDetailModalProps> = ({ open, product, onClose }) => {
                            ...
                            InputProps={{
                                endAdornment: (
                                    <InputAdornment position="end">
                                        <IconButton onClick={handleSubmitComment} sx={{ color: '#cda45e' }}>
                                            <FaPaperPlane />
                                        </IconButton>
                                    </InputAdornment>
                                ),
