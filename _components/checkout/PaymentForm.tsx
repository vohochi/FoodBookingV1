...
export default function PaymentForm({ onPaymentUpdate }: { onPaymentUpdate: (paymentId: string) => void }) {
  ...
  return (
    <Stack spacing={{ xs: 3, sm: 6 }} useFlexGap>
      <FormControl component="fieldset" fullWidth>
        <Typography sx={{ fontWeight: 'bold', fontSize: '24px', textAlign: 'center', mb: 3 }}>
            ...
            <Card key={method._id} selected={paymentId === method._id}> {/* So sánh với _id */}
              ...
              >
                <CardContent sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                  ...
                  />
                  <Typography sx={{ fontWeight: 'medium' }}>{method.description}</Typography>
                </CardContent>
              </CardActionArea>
            </Card>
          ))}
